...
public class NumbersRegressionTest extends BaseTestCase {
    ...
    public void testBug5729() throws Exception {
    	if (versionMeetsMinimum(4, 1)) {
	    	...
	    	try {
	    		...
	    		this.stmt.executeUpdate("CREATE TABLE testBug5729(field1 BIGINT UNSIGNED)");
    ...
    /**
     * Tests fix for BUG#8484 - ResultSet.getBigDecimal() throws exception
     * when rounding would need to occur to set scale.
     * 
     * @throws Exception if the test fails
     * @deprecated
     */
    public void testBug8484() throws Exception {
    	try {
    		...
    		this.stmt.executeUpdate("CREATE TABLE testBug8484 (field1 DECIMAL(16, 8), field2 varchar(32))");
