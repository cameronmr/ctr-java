 ...
 * @version $Id: DateTest.java,v 1.4.4.11 2004/12/01 21:53:35 mmatthew Exp $
 */
public class DateTest extends BaseTestCase {
    ...
    public void testNanosParsing() throws SQLException {
    	try {
    		...
    		this.stmt.executeUpdate("INSERT INTO testNanosParsing VALUES (1, '1969-12-31 18:00:00.0'), " +
    ...
    /**
     * Tests the configurability of all-zero date/datetime/timestamp handling
     * in the driver.
     * 
    ...
    public void testZeroDateBehavior() throws Exception {
    	try {
    		...
    		assertTrue("0001-01-01".equals(this.rs.getDate(1).toString()));
    		assertTrue("0001-01-01 00:00:00.0".equals(this.rs.getTimestamp(1).toString()));
    		assertTrue("0001-01-01".equals(this.rs.getDate(2).toString()));
    		assertTrue("0001-01-01 00:00:00.0".equals(this.rs.getTimestamp(2).toString()));
