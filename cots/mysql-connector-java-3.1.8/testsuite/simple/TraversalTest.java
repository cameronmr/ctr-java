 ...
 * @version $Id: TraversalTest.java,v 1.6.4.6 2004/09/18 03:31:17 mmatthew Exp $
 */
public class TraversalTest
    ...
    public void testTraversal()
        ...
        try {
            ...
            assertTrue("ResultSet.absolute() from off this.rs to on this.rs failed", 
                       onResultSet);
