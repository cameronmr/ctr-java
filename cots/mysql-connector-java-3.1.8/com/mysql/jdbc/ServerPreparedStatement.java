 ...
 * @version $Id: ServerPreparedStatement.java,v 1.1.2.73 2005/04/07 18:39:38 mmatthews Exp $
 */
public class ServerPreparedStatement extends PreparedStatement {
    ...
    */
	...
	//
	private void storeReader(MysqlIO mysql,
			int parameterIndex,
			Buffer packet, 
			Reader inStream)
	    throws SQLException {
		...
		try {	
	        ...
	        while ((numRead = inStream.read(buf)) != -1) {
	        	byte[] valueAsBytes = StringUtils.getBytes(buf,
	        			null,
	...
	private void storeStream(MysqlIO mysql,
			int parameterIndex,
			Buffer packet, 
