...
/**
 * MySQL wrapper for DataTruncation until the server can support
 * sending all needed information.
 * 
 * @author Mark Matthews
 *
 * @version $Id: MysqlDataTruncation.java,v 1.1.2.4 2004/08/12 20:28:31 mmatthew Exp $
 */
public class MysqlDataTruncation extends DataTruncation {
	 ...
	 */
	public MysqlDataTruncation(String message, int index, boolean parameter, boolean read,
