 ...
 *
 * @author dgan
 * @version $Id: RowDataDynamic.java,v 1.8.4.22 2005/01/25 19:11:42 mmatthew Exp $
 */
public class RowDataDynamic implements RowData {
    ...
    public RowDataDynamic(MysqlIO io, int colCount, 
    		Field[] fields, boolean isBinaryEncoded) 
    	throws SQLException {
        this.io = io;
    ...
    private void nextRecord() throws SQLException {
        ...
        try {
			...
			throw new java.sql.SQLException(
				...
				+ exceptionType + Messages.getString("RowDataDynamic.9") + exceptionMessage, SQLError.SQL_STATE_GENERAL_ERROR); //$NON-NLS-1$
		}
    }
