 ...
 * @version $Id: Blob.java,v 1.9.4.8 2004/08/12 20:28:29 mmatthew Exp $
 */
public class Blob implements java.sql.Blob, OutputStreamWatcher {
    ...
    /**
     * Creates an updatable BLOB that can update in-place  (not implemented
     * yet).
     *
     * @param data DOCUMENT ME!
    ...
    public void streamClosed(WatchableOutputStream out) {
        ...
        if (streamSize < this.binaryData.length) {
            out.write(this.binaryData, streamSize,
                this.binaryData.length - streamSize);
        }
