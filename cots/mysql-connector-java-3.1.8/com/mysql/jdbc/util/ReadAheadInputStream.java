 ...
 * 
 * @version $Id: ReadAheadInputStream.java,v 1.1.2.4 2005/02/01 23:01:43 mmatthew Exp $
 */
public class ReadAheadInputStream extends InputStream {
	 ...
	 *  
	 */
	public ReadAheadInputStream(InputStream toBuffer, boolean debug) {
		this(toBuffer, DEFAULT_BUFFER_SIZE, debug);
	}

	public ReadAheadInputStream(InputStream toBuffer, int bufferSize, boolean debug) {
