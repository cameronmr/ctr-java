 ...
 * @version $Id: PreparedStatement.java,v 1.27.4.61 2005/04/07 23:56:15 mmatthews Exp $
 *
...
public class PreparedStatement extends com.mysql.jdbc.Statement
	...
	private final static byte[] HEX_DIGITS = new byte[] { (byte) '0', (byte) '1', (byte) '2', (byte) '3', (byte) '4', (byte) '5', (byte) '6', (byte) '7', (byte) '8', (byte) '9', (byte) 'A', (byte) 'B', (byte) 'C', (byte) 'D', (byte) 'E', (byte) 'F' };
                ...
                case Types.NUMERIC:
                    ...
                    if (parameterObj instanceof Boolean) {
                        ...
                        case Types.BIT:
                            ...
                            parameterAsNum = parameterAsBoolean
                                ? new Integer(1) : new Integer(0);
    ...
    protected ResultSet executeInternal(int maxRowsToRetrieve,
        ...
        rs = this.connection.execSQL(this, null, maxRowsToRetrieve, sendPacket,
                ...
                createStreamingResultSet, false,
