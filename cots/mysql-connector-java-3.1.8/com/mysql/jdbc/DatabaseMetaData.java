 ...
 * @version $Id: DatabaseMetaData.java,v 1.27.4.64 2005/04/14 20:36:13 mmatthews Exp $
 */
public class DatabaseMetaData implements java.sql.DatabaseMetaData {
            ...
            try {
                ...
                if (this.conn.versionMeetsMinimum(3, 23, 50)) {
                    ...
                    if (foreignCatalog != null) {
						...
						if (!this.conn.getNullCatalogMeansCurrent()) {
							throw new SQLException("'foreignCatalog' parameter can not be null", 
									SQLError.SQL_STATE_ILLEGAL_ARGUMENT);
						}
                    }
    ...
    public String getDriverVersion() throws java.sql.SQLException {
        return "mysql-connector-java-3.1.8 ( $Date: 2005/04/14 20:36:13 $, $Revision: 1.27.4.64 $ )";
    }
    ...
    public java.sql.ResultSet getProcedureColumns(String catalog,
        ...
        for (Iterator iter = proceduresToExtractList.iterator();
            ...
            getCallStmtParameterTypes(catalog, procName, columnNamePattern, resultRows);
        }
    	...
    	switch (type) {
    		case ResultSet.TYPE_SCROLL_INSENSITIVE:
    			if ((concurrency == ResultSet.CONCUR_READ_ONLY) ||
    				...
    				throw new SQLException("Illegal arguments to supportsResultSetConcurrency()", 
        					SQLError.SQL_STATE_ILLEGAL_ARGUMENT);
    			}
     ...
     * @see #getSearchStringEscape
     */
    private void getCallStmtParameterTypes(String catalog, 
    	String procName,
		...
		if (parameterNamePattern == null) {
			if (this.conn.getNullNamePatternMatchesAll()) {
				...
				throw new SQLException("Parameter/Column name pattern can not be NULL or empty.",
						SQLError.SQL_STATE_ILLEGAL_ARGUMENT);
			}   
		}
        ...
        try {
            ...
            if (!" ".equals(quoteChar)) {
            	dotIndex = StringUtils.indexOfIgnoreCaseRespectQuotes(0, procName, 
            			".", 
            			quoteChar.charAt(0), 
            ...
            if (paramRetrievalRs.next()) {
                ...
                int openParenIndex = StringUtils.indexOfIgnoreCaseRespectQuotes(0, 
                ...
                int beginIndex = StringUtils.indexOfIgnoreCaseRespectQuotes(0, procedureDef,
